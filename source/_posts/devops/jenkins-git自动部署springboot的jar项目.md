...
```
http://admin:b4b0b62f9eaa2b32ade40d88cbe8738a@web.cloud4water.com:8080/job/testJenkinsDocker/build?token=123456
```

这个url的格式为三段式:
http://
admin:b4b0b62f9eaa2b32ade40d88cbe8738a@
web.cloud4water.com:8080/job/testJenkinsDocker/build?token=123456
